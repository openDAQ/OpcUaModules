...
void OpcUaServerTestHelper::createModel()
{
    ...
    {
        UA_SByte myInt8 = -8;
        publishVariable(".i8", &myInt8, &UA_TYPES[UA_TYPES_SBYTE], &uaObjectsFolder);

        UA_Byte myUInt8 = 8;
        publishVariable(".ui8", &myUInt8, &UA_TYPES[UA_TYPES_BYTE], &uaObjectsFolder);
    }
